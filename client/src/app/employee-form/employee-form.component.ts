  ...
  template: `
    ...
    >
      <mat-form-field>
        ...
        <mat-error *ngIf="name.invalid && name.touched">Name must be at least 3 characters long.</mat-error>
      </mat-form-field>
      ...
      <mat-form-field>
        ...
        <input
          ...
          required
        />
        <mat-error *ngIf="position.invalid && position.touched">Position must be at least 5 characters long.</mat-error>
      </mat-form-field>
...
export class EmployeeFormComponent {
  ...
  ngOnInit() {
    this.employeeForm = this.formBuilder.group({
      name: [this.initialState?.name || '', [Validators.required, Validators.minLength(3)]],
      position: [this.initialState?.position || '', [Validators.required, Validators.minLength(5)]],
      level: [this.initialState?.level || 'junior', [Validators.required]],
    });
  }
